...
```{r accuracy2, cache= TRUE, echo= FALSE, warning= FALSE, message= FALSE, results= 'as.is'}
kable(output)
```
...
```{r accuracy6, cache= TRUE, echo= FALSE, warning= FALSE, message= FALSE, results= 'as.is'}
kable(output1)
```
